...
bel_region_districts = {
    ...
    'Белгородский р-н': {
        # МЧС пишет и «Белгородский район», и «Белгородском МО», и «в г. Белгороде».
        # Формы на «-ская/-ской» намеренно не берём: «Белгородской области» должна
        # уходить в 'Вся область' по ключу 'област'.
        'keys': ['белгородский', 'белгородском', 'белгороде', 'белгород ', 'белгород.', ],
    },
    # 'Белгород': {
